...
<?php include("header.php");?>
   ...
   <div class="portfolio">
	<section class="wrap">
		...
		<div class="intro">
			<h1 class="title">Min Portefølje</h1>
			<section class="intro-text">
				<p>Velkommen til min portefølje. Her kan du se projekter jeg har arbejdet på indenfor web-design, front-end udvikling og en smule fotografi.</p>			
			</section>
		</div> <!-- intro-text END -->
		...
		<article class="portfolio-item">
			<h2 class="subhead">CSS3: <br/>iPhone 6</h2>
